...
class _AddItemScreenState extends State<AddItemScreen> {
  ...
  // ==========================================
  // CUSTOM GALLERY BOTTOM SHEET (Grid View)
  // ==========================================
  void _showCustomGallery(int imageIndex) {
    showModalBottomSheet(
      context: context,
      isScrollControlled: true, // Taake sheet thori bari khul sake
                ...
                Expanded(
                  child: GridView.builder(
                    ...
                    itemBuilder: (context, index) {
                      return InkWell(
                        onTap: () {
                          // Picture select hone par box mein lagana
                          setState(() {
                            if (imageIndex == 1) {
  ...
  // ==========================================
  // IMAGE PICKER LOGIC (Camera & Custom Gallery)
  // ==========================================
        ...
        return Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              // ✅ Ab yahan native gallery ki jagah aapki Custom Asset Gallery khulegi
              ListTile(
                ...
                onTap: () {
                  Get.back(); // Pehle yeh choti sheet band hogi
                  _showCustomGallery(imageIndex); // Phir bari gallery grid khulegi
                },
              ),
  ...
  // ✅ Reusable Image Picker Box (Ab yeh String aur File dono accept karega)
  Widget _buildImagePickerBox({required dynamic image, required VoidCallback onTap}) {
    ImageProvider? imageProvider;
    if (image is String) {
      imageProvider = AssetImage(image); // Agar asset gallery se hai
    } else if (image is File) {
      imageProvider = FileImage(image); // Agar camera se hai
    }
